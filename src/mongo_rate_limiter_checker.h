...
namespace mongo {
    ...
    public:
        ...
        virtual void resetRequestTokens() { _requestTokens.store(0, std::memory_order_relaxed); }
        ...
        virtual int64_t getTokensPerSecond() { return _rateLimiter->GetBytesPerSecond(); }
