...
#define DEFAULT_NUM_STRIPES 32
    ...
    struct TOTransactionDBOptions {
        ...
        TOTransactionDBOptions(int max_conflict_check_bytes_size_mb)
            : max_conflict_check_bytes_size(max_conflict_check_bytes_size_mb * 1024 * 1024) {}
    };
    ...
    public:
        ...
        ~ShouldNotCheckOldestTsBlock() { _to_comparator->clearSetOldestTs(); }
    ...
    public:
        ...
        virtual Status SetTimeStamp(const TimeStampType& ts_type, const RocksTimeStamp& ts,
                                    bool force = false) = 0;
