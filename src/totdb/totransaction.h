...
namespace rocksdb {
    ...
    public:
        ...
        // set read timestamp for transaction, if the application set the commit timestamp twice, an
        ...
        virtual Status Get(ReadOptions& options, const Slice& key, std::string* value) = 0;
